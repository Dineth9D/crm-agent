...
class TextChunker:
    ...
    def ___init__(self, chunk_size: int = None, overlap: int = None):
        """
        Initialize chunker with configuration.

        Args:
            chunk_size: Approximate token per chunk (default from settings)
            overlap: Approximate token overlap between chunks (default from settings)
        """
    ...
    def chunk_text(self, text: str, source: str, base_chunk_id: str) -> List[Dict[str, Any]]:
        ...
        logger.info(f"Chunked text into {len(chunks)} chunks from source: {source}")
        return chunks
    ...
    def chunk_documents(self, documents: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        Args:
            documents: List of document dictionaries with 'text', 'source', and 'chunk_id' keys
